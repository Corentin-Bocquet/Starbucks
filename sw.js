...
const CORE = [
  ...
  './js/data/codex.data.js', './js/data/cocktails.plus.js', './js/data/codex.config.js', './js/data/seed.js', './js/data/moods.js', './js/data/aliments.js', './js/data/sport.js',
