...
(function (global) {
  ...
  const MUSCLES = {
    ...
    'delt-a':  { nom: 'Épaules (avant)',      face: 'avant' },
    'delt-m':  { nom: 'Épaules (côté)',       face: 'avant' },
    'delt-p':  { nom: 'Épaules (arrière)',    face: 'arriere' },
    ...
    'trap':    { nom: 'Trapèzes',             face: 'arriere' },
    'rhom':    { nom: 'Rhomboïdes',           face: 'arriere' },
    ...
    'flechh':  { nom: 'Fléchisseurs de hanche', face: 'avant' },
  ...
  const GROUPES = [
    ...
    { id: 'trapezes',    nom: 'Trapèzes',             icon: 'muscle' },
    { id: 'avantbras',   nom: 'Avant-bras et poigne', icon: 'muscle' },
    { id: 'calisthenie', nom: 'Calisthénie',          icon: 'muscle' }
  ];
  ...
  const BRUT = [
    ...
    /* --- Pectoraux --- */
    ["Développé couché", 'pectoraux', 'barre', 0.4, 'charge', ['pect'], ['tri', 'delt-a'], 0],
    ["Développé incliné", 'pectoraux', 'barre', 0.4, 'charge', ['pect'], ['delt-a', 'tri'], 0],
    ["Développé décliné", 'pectoraux', 'barre', 0.38, 'charge', ['pect'], ['tri', 'delt-a'], 0],
    ["Développé couché prise serrée", 'pectoraux', 'barre', 0.42, 'charge', ['pect', 'tri'], ['delt-a'], 0],
    ["Développé couché prise large", 'pectoraux', 'barre', 0.34, 'charge', ['pect'], ['delt-a', 'tri'], 0],
    ["Développé couché haltères", 'pectoraux', 'halteres', 0.44, 'charge', ['pect'], ['tri', 'delt-a'], 0],
    ["Développé incliné haltères", 'pectoraux', 'halteres', 0.44, 'charge', ['pect'], ['delt-a', 'tri'], 0],
    ["Développé décliné haltères", 'pectoraux', 'halteres', 0.42, 'charge', ['pect'], ['tri', 'delt-a'], 0],
    ["Développé haltères prise neutre", 'pectoraux', 'halteres', 0.44, 'charge', ['pect'], ['tri', 'delt-a'], 0],
    ["Développé haltère unilatéral", 'pectoraux', 'halteres', 0.44, 'charge', ['pect'], ['tri', 'delt-a', 'transv'], 0],
    ["Écartés haltères couché", 'pectoraux', 'halteres', 0.55, 'charge', ['pect'], ['delt-a'], 0],
    ["Écartés haltères inclinés", 'pectoraux', 'halteres', 0.55, 'charge', ['pect'], ['delt-a'], 0],
    ["Écartés haltères déclinés", 'pectoraux', 'halteres', 0.52, 'charge', ['pect'], ['delt-a'], 0],
    ["Écartés à la poulie", 'pectoraux', 'poulie', 0.6, 'charge', ['pect'], ['delt-a'], 0],
    ...
    ["Pompes serrées", 'pectoraux', 'corps', 0.38, 'corps', ['tri', 'pect'], ['delt-a'], 0.66],
    ["Pompes déclinées", 'pectoraux', 'corps', 0.35, 'corps', ['pect'], ['delt-a', 'tri'], 0.72],
    ["Pompes lestées", 'pectoraux', 'corps', 0.35, 'corpsplus', ['pect'], ['tri', 'delt-a', 'transv'], 0.64],
    ...
    ["Tractions lestées", 'dos', 'corps', 0.55, 'corpsplus', ['dors'], ['bi', 'rond', 'trap'], 1.0],
    ["Tirage vertical pronation large", 'dos', 'machine', 0.55, 'charge', ['dors'], ['rond', 'bi', 'trap'], 0],
    ["Tirage vertical pronation serrée", 'dos', 'machine', 0.58, 'charge', ['dors'], ['bi', 'rond'], 0],
    ...
    ["Tirage vertical unilatéral", 'dos', 'machine', 0.58, 'charge', ['dors'], ['bi', 'rond', 'transv'], 0],
    ...
    ["Rowing haltère unilatéral", 'dos', 'halteres', 0.45, 'charge', ['dors'], ['bi', 'trap', 'rhom'], 0],
    ["Rowing haltères bilatéral", 'dos', 'halteres', 0.42, 'charge', ['dors'], ['trap', 'rhom', 'bi'], 0],
    ["Rowing haltères buste sur banc", 'dos', 'halteres', 0.42, 'charge', ['trap', 'rhom'], ['dors', 'delt-p'], 0],
    ["Rowing haltères prise neutre", 'dos', 'halteres', 0.42, 'charge', ['dors'], ['bi', 'trap'], 0],
    ["Rowing haltères coudes ouverts", 'dos', 'halteres', 0.4, 'charge', ['delt-p', 'trap'], ['rhom', 'dors'], 0],
    ...
    ["Tirage horizontal à la corde", 'dos', 'poulie', 0.45, 'charge', ['dors', 'trap'], ['rhom', 'delt-p'], 0],
    ["Tirage horizontal unilatéral", 'dos', 'poulie', 0.48, 'charge', ['dors'], ['bi', 'trap', 'transv'], 0],
    ["Soulevé de terre", 'dos', 'barre', 0.5, 'charge', ['lomb', 'fess'], ['isch', 'trap', 'dors', 'quad'], 0],

    /* --- Epaules --- */
    ["Développé militaire barre", 'epaules', 'barre', 0.5, 'charge', ['delt-a'], ['delt-m', 'tri'], 0],
    ["Développé haltères épaules", 'epaules', 'halteres', 0.52, 'charge', ['delt-a', 'delt-m'], ['tri'], 0],
    ["Développé Arnold", 'epaules', 'halteres', 0.55, 'charge', ['delt-a', 'delt-m'], ['tri'], 0],
    ["Développé épaules machine", 'epaules', 'machine', 0.5, 'charge', ['delt-a', 'delt-m'], ['tri'], 0],
    ["Développé unilatéral haltère", 'epaules', 'halteres', 0.52, 'charge', ['delt-a', 'delt-m'], ['tri', 'transv'], 0],
    ["Élévations latérales haltères", 'epaules', 'halteres', 0.45, 'charge', ['delt-m'], ['supra'], 0],
    ["Élévations latérales poulie", 'epaules', 'poulie', 0.48, 'charge', ['delt-m'], ['supra'], 0],
    ["Élévation latérale unilatérale poulie", 'epaules', 'poulie', 0.5, 'charge', ['delt-m'], ['supra'], 0],
    ["Élévations latérales machine", 'epaules', 'machine', 0.45, 'charge', ['delt-m'], ['supra'], 0],
    ["Élévations latérales inclinées", 'epaules', 'halteres', 0.48, 'charge', ['delt-m'], ['supra'], 0],
    ["Oiseau haltères", 'epaules', 'halteres', 0.45, 'charge', ['delt-p'], ['trap', 'rhom'], 0],
    ["Oiseau sur banc incliné", 'epaules', 'halteres', 0.45, 'charge', ['delt-p'], ['rhom', 'trap'], 0],
    ["Oiseau à la poulie", 'epaules', 'poulie', 0.5, 'charge', ['delt-p'], ['rhom', 'trap'], 0],
    ["Pec-deck inversé", 'epaules', 'machine', 0.45, 'charge', ['delt-p'], ['trap', 'rhom'], 0],
    ["Tirage visage", 'epaules', 'poulie', 0.4, 'charge', ['delt-p'], ['trap', 'rhom', 'coiffe'], 0],

    /* --- Biceps --- */
    ["Curl alterné", 'biceps', 'halteres', 0.38, 'charge', ['bi'], ['brach', 'avb'], 0],
    ["Curl marteau", 'biceps', 'halteres', 0.38, 'charge', ['brach'], ['bi', 'avb'], 0],
    ["Curl incliné", 'biceps', 'halteres', 0.42, 'charge', ['bi'], ['brach'], 0],
    ["Curl concentré", 'biceps', 'halteres', 0.36, 'charge', ['bi'], ['brach'], 0],
    ...
    ["Curl barre prise serrée", 'biceps', 'barre', 0.38, 'charge', ['bi'], ['brach'], 0],
    ["Curl inversé", 'biceps', 'barre', 0.36, 'charge', ['brach'], ['bi', 'avb'], 0],
    ["Curl poulie basse", 'biceps', 'poulie', 0.38, 'charge', ['bi'], ['brach', 'avb'], 0],
    ["Curl poulie à la corde", 'biceps', 'poulie', 0.38, 'charge', ['brach'], ['bi'], 0],
    ["Curl poulie unilatéral", 'biceps', 'poulie', 0.38, 'charge', ['bi'], ['brach'], 0],
    ["Curl Bayesian", 'biceps', 'poulie', 0.42, 'charge', ['bi'], ['brach'], 0],
    ["Curl poulie haute", 'biceps', 'poulie', 0.4, 'charge', ['bi'], ['brach', 'avb'], 0],

    /* --- Triceps --- */
    ["Extension triceps à la corde", 'triceps', 'poulie', 0.35, 'charge', ['tri'], [], 0],
    ["Extension triceps à la barre", 'triceps', 'poulie', 0.33, 'charge', ['tri'], [], 0],
    ["Extension au-dessus de la tête", 'triceps', 'poulie', 0.45, 'charge', ['tri'], [], 0],
    ...
    ["Dips lestés", 'triceps', 'corps', 0.4, 'corpsplus', ['tri', 'pect'], ['delt-a'], 0.95],
    ...
    ["Presse à cuisses", 'quadriceps', 'machine', 0.45, 'charge', ['quad', 'fess'], ['isch'], 0],
    ["Hack squat", 'quadriceps', 'machine', 0.5, 'charge', ['quad'], ['fess', 'add'], 0],
    ["Squat pendulaire", 'quadriceps', 'machine', 0.5, 'charge', ['quad'], ['fess'], 0],
    ["Squat à la Smith", 'quadriceps', 'machine', 0.52, 'charge', ['quad', 'fess'], ['isch'], 0],
    ...
    ["Hip thrust unilatéral", 'fessiers', 'barre', 0.3, 'charge', ['fess'], ['isch', 'fess-m'], 0],
    ...
    ["Fentes marchées", 'fessiers', 'halteres', 0.45, 'charge', ['fess', 'quad'], ['isch', 'transv'], 0],

    /* --- Ischio-jambiers --- */
    ["Soulevé de terre roumain", 'ischios', 'barre', 0.45, 'charge', ['isch', 'fess'], ['lomb'], 0],
    ["Soulevé de terre jambes tendues", 'ischios', 'barre', 0.48, 'charge', ['isch'], ['fess', 'lomb'], 0],
    ["Leg curl allongé", 'ischios', 'machine', 0.35, 'charge', ['isch'], ['mol'], 0],
    ...
    ["Mollets à la presse", 'mollets', 'machine', 0.15, 'charge', ['mol', 'sol'], [], 0],
    ["Mollets à la machine", 'mollets', 'machine', 0.15, 'charge', ['mol'], ['sol'], 0],
    ["Mollets unilatéraux", 'mollets', 'corps', 0.16, 'corpsplus', ['mol', 'sol'], [], 0.9],

    /* --- Abdominaux --- */
    ["Crunch", 'abdominaux', 'corps', 0.25, 'corps', ['abdo'], ['obl'], 0.3],
    ["Crunch à la poulie", 'abdominaux', 'poulie', 0.3, 'charge', ['abdo'], ['obl'], 0],
    ["Relevé de jambes suspendu", 'abdominaux', 'corps', 0.5, 'corps', ['abdo', 'flechh'], ['obl'], 0.35],
    ["Relevé de genoux", 'abdominaux', 'corps', 0.4, 'corps', ['abdo'], ['flechh'], 0.3],
    ...
    ["Planche latérale", 'abdominaux', 'corps', 0, 'iso', ['obl'], ['transv', 'lomb'], 0.55],
    ["Planche lestée", 'abdominaux', 'corps', 0, 'iso', ['abdo', 'transv'], ['obl'], 0.6],
    ["Planche commando", 'abdominaux', 'corps', 0.25, 'corps', ['abdo'], ['delt-a', 'tri'], 0.6],
    ["Planche avec élévation de jambe", 'abdominaux', 'corps', 0, 'iso', ['abdo', 'transv'], ['fess', 'obl'], 0.6],

    /* --- Trapezes --- */
    ["Haussements d'épaules barre", 'trapezes', 'barre', 0.15, 'charge', ['trap'], [], 0],
    ["Haussements d'épaules haltères", 'trapezes', 'halteres', 0.15, 'charge', ['trap'], ['avb'], 0],
    ["Haussements d'épaules machine", 'trapezes', 'machine', 0.15, 'charge', ['trap'], [], 0],
    ...
    ["Curl inversé poignets", 'avantbras', 'barre', 0.36, 'charge', ['brach'], ['avb'], 0],
    ["Suspension à la barre", 'avantbras', 'corps', 0, 'iso', ['avb'], ['dors'], 1.0],
    ...
    ["Équilibre sur les mains", 'calisthenie', 'corps', 0, 'iso', ['delt-a'], ['tri', 'transv'], 1.0],
  ];
  ...
  const SPORTS = [
    /* --- Course et marche --- */
    { id: 'course',        nom: 'Course à pied',        met: 9.8,  fam: 'Course et marche' },
    ...
    { id: 'randonnee',     nom: 'Randonnée',            met: 6.0,  fam: 'Course et marche' },
    { id: 'escaliers',     nom: 'Montée d\'escaliers',   met: 8.8,  fam: 'Course et marche' },
    { id: 'stepper',       nom: 'Stepper',              met: 7.5,  fam: 'Course et marche' },

    /* --- Velo --- */
    { id: 'velo',          nom: 'Vélo',                 met: 8.0,  fam: 'Vélo' },
    { id: 'velo-appart',   nom: 'Vélo d\'appartement',   met: 7.0,  fam: 'Vélo' },
    { id: 'vtt',           nom: 'VTT',                  met: 8.5,  fam: 'Vélo' },
    { id: 'spinning',      nom: 'Spinning',             met: 8.5,  fam: 'Vélo' },
    { id: 'handbike',      nom: 'Handbike',             met: 6.5,  fam: 'Vélo' },

    /* --- Salle et renforcement --- */
    { id: 'muscu',         nom: 'Musculation',          met: 5.0,  fam: 'Salle' },
    { id: 'muscu-legere',  nom: 'Musculation légère',   met: 3.5,  fam: 'Salle' },
    { id: 'crossfit',      nom: 'Cross-training',       met: 8.0,  fam: 'Salle' },
    { id: 'hiit',          nom: 'Fractionné (HIIT)',    met: 10.0, fam: 'Salle' },
    { id: 'circuit',       nom: 'Circuit training',     met: 7.5,  fam: 'Salle' },
    { id: 'calisthenie',   nom: 'Calisthénie',          met: 6.0,  fam: 'Salle' },
    { id: 'rameur',        nom: 'Rameur',               met: 8.5,  fam: 'Salle' },
    { id: 'elliptique',    nom: 'Elliptique',           met: 6.5,  fam: 'Salle' },
    { id: 'corde',         nom: 'Corde à sauter',       met: 11.0, fam: 'Salle' },
    { id: 'core',          nom: 'Gainage et abdos',     met: 4.0,  fam: 'Salle' },
    { id: 'fonctionnel',   nom: 'Entraînement fonctionnel', met: 5.5, fam: 'Salle' },
    { id: 'souplesse',     nom: 'Étirements',           met: 2.3,  fam: 'Salle' },
    ...
    { id: 'mobilite',      nom: 'Mobilité',             met: 2.8,  fam: 'Salle' },
    ...
    { id: 'football-us',   nom: 'Football américain',   met: 8.0,  fam: 'Sports de ballon' },
    ...
    { id: 'plongee',       nom: 'Plongée',              met: 7.0,  fam: 'Sports d\'eau' },
    { id: 'snorkeling',    nom: 'Randonnée palmée',     met: 5.0,  fam: 'Sports d\'eau' },
    ...
    { id: 'raquettes-neige', nom: 'Raquettes à neige',  met: 7.5,  fam: 'Neige et glace' },
    ...
    { id: 'karate',        nom: 'Karaté et taekwondo',  met: 10.3, fam: 'Sports de combat' },
