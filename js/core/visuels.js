...
(function (global) {
  ...
  const DISPO = 'a-commander,a-faire,a-voir,accessoires,activite,actualiser,aider,ail,ajouter,alcool,alcoolise,ami,angostura,animal,anis,apero,apple-sante,apprendre,apres-ski,asperges,avion,baguette-magique,bain,bain-glace,bar,barbecue,bas,basilic,bateau,beach-volley,beef-jerky,betteraves,beurre,bien-habille,biere,blanc-oeuf,blender,boeuf,bons-plans,boomerang,boudoirs,bouillon,bouquet-garni,bourbon,boussole,bowling,boxe,brandy-mure,brunch,cacahuetes,cacahuetes-3d,cacao,cadeau,cafe,cafe-calme,cafe-filtre,cafe-lieu,cafe-soluble,calendrier,calin,calories,campari,canyoning,caramel,cardio,carottes,cassonade,cat-autre,cat-culture,cat-ete,cat-food,cat-fun,cat-hiver,cat-insolite,cat-plage,cat-sport,cerf-volant,chai,chambord,champignons,chapelure,char-voile,chaussettes,chaussures,chercher,chili,chill,chocolat-lait,chocolat-noir,cinema,citron-jaune,citron-vert,ck-bar-oui,ck-chic,ck-corse,ck-cremeux,ck-frais,ck-gin,ck-peu-importe,ck-rhum,ck-tequila,ck-tropical,ck-vodka,ck-whisky,classe,codebarre,cognac,coiffeur,coins-discrets,collegue,comptes,connue,coucher-soleil,couple,courgettes,course,cran,creme,creme-coco,creme-fraiche,crepe,croutons,cuisiner,cuisiner-ensemble,cuisiner-pour,culture,dahl,de,defi,demander,deux-cafes,diner-deux,dormir,dormir-amis,douche-froide,dunes,eau,eau-gazeuse,ecrire,effacer,elan,enfant,epices,equitation,escalade,escape,espresso,estragon,etirements,exporter,exposition,famille,farine,fauteuil,favoris,fierte,film-blotti,fondue,fondue-bourguignonne,foot,fratrie,fromage,fruit-passion,fruits,fuet,galerie,gaufre,gin,glace,glucides,golf,grains-cafe,grands-parents,grenadine,guide,haut,herbes,histoire,historique,hot-dog,huile,hydratation,ic-cafe,ic-manger,ic-savoir,ic-shopping,ic-sortir,ic-verre,jambon,jeu-video,jeux-plage,jeux-societe,jus-ananas,jus-canneberge,jus-orange,jus-pamplemousse,karting,kine,kitesurf,kobe,lait,lait-vegetal,lardons,lecture,legumes,levure,lieu,liqueur-banane,liqueur-cafe,listes,luge,luge-rail,mails,mais,marche,marche-defi,marcher,marcher-deux,mascarpone,massage,matcha,menthe,message,meteo-chaud,meteo-froid,meteo-pluie,meteo-soleil,mini-golf,mm-apero,mm-chaud,mm-dessert,mm-entree,mm-express,mm-four,mm-froid,mm-mijote,mm-peu-importe,mm-plat,mm-sansfour,molkky,mood,munster,muscle,musculation,musee,musique,noix,noter,objectifs,oeufs,oignon,oldmoney,pancakes-sales,paprika,parapente,parent,parents,parfum,parler,pas,pate-cacahuete,pate-tarte,patinoire,penderie,persil,petanque,peu-importe,photo-tenue,pique-nique,plage,plat-enfance,plateau,poids,poisson,poivre,pommes-de-terre,pompes,porc-caramel,poulet,pratique,proteines,publier,rafting,rando-groupe,randonnee,ranger,raquettes-neige,raquettes-plage,recette-inventee,reconfort,record,repas-potes,restaurant,rhum,rhum-blanc,rhum-overproof,ribs,rillettes,rire,riz,rosalie,roti,roue,rye,salade-verte,sale,sans-alcool,sardines,sauce-chocolat,saucisson,sauna,sb-cafe,sb-chaud,sb-equilibre,sb-fruit,sb-glace,sb-gourmand,sb-lait,sb-leger,sb-mixe,sb-the,scanner,seance-lourde,sel,semaine,sirop-canne,sirop-saison,sirop-sucre,sirop-vanille,sirop-violette,ski,ski-fond,snowboard,soda-pamplemousse,soiree,soiree-deux,sommeil,sourire,sous-vetement,souvenirs,spa,speculoos,sport,sport-co,sport-tenue,sucre,sucre-cat,surprise,sushi,sushis,t-bone,tache,telephone,tendresse,tennis,tenue,tequila,terrine,the,thon,tomates,tomates-farcies,tomates-sechees,tous,trail,triple-sec,trois-idees,ufc,vanille,veau,velo,velo-route,vermouth-rouge,vermouth-sec,veste,via-ferrata,viande,video,villa,vin-blanc,vin-cuit,vin-rouge,vinaigre-balsamique,vinaigre-cidre,visite,vodka,vtt,vtt-descente,whisky,wraps'.split(',');
