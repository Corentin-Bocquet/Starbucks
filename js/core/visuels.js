...
(function (global) {
  ...
  const DISPO = 'a-commander,a-faire,a-voir,accessoires,activite,actualiser,aider,ail,ajouter,alcool,alcoolise,ami,angostura,anis,apero,apple-sante,apprendre,apres-ski,asperges,avion,baguette-magique,bar,barbecue,bas,basilic,bateau,beach-volley,betteraves,beurre,bien-habille,biere,blanc-oeuf,blender,boeuf,bons-plans,boomerang,boudoirs,bouillon,bouquet-garni,bourbon,boussole,bowling,brandy-mure,brunch,cacahuetes,cacao,cadeau,cafe,cafe-calme,cafe-filtre,cafe-lieu,cafe-soluble,calendrier,calories,campari,canyoning,caramel,cardio,carottes,cassonade,cat-autre,cat-culture,cat-ete,cat-food,cat-fun,cat-hiver,cat-insolite,cat-plage,cat-sport,cerf-volant,chai,chambord,champignons,chapelure,char-voile,chaussettes,chaussures,chercher,chili,chill,chocolat-lait,chocolat-noir,cinema,citron-jaune,citron-vert,ck-bar-oui,ck-chic,ck-corse,ck-cremeux,ck-frais,ck-gin,ck-peu-importe,ck-rhum,ck-tequila,ck-tropical,ck-vodka,ck-whisky,classe,codebarre,cognac,coiffeur,coins-discrets,collegue,comptes,connue,coucher-soleil,couple,courgettes,course,cran,creme,creme-coco,creme-fraiche,crepe,croutons,cuisiner,cuisiner-ensemble,culture,de,defi,deux-cafes,dormir-amis,douche-froide,dunes,eau,eau-gazeuse,ecrire,effacer,elan,enfant,epices,equitation,escalade,escape,espresso,estragon,exporter,exposition,famille,farine,favoris,fierte,fondue,foot,fratrie,fromage,fruit-passion,fruits,galerie,gaufre,gin,glace,glucides,golf,grains-cafe,grands-parents,grenadine,guide,haut,herbes,histoire,historique,huile,hydratation,ic-cafe,ic-manger,ic-savoir,ic-shopping,ic-sortir,ic-verre,jambon,jeu-video,jeux-plage,jeux-societe,jus-ananas,jus-canneberge,jus-orange,jus-pamplemousse,karting,kitesurf,lait,lait-vegetal,lardons,lecture,legumes,levure,lieu,liqueur-banane,liqueur-cafe,listes,luge,luge-rail,mails,mais,marche,marche-defi,marcher,mascarpone,massage,matcha,menthe,message,meteo-chaud,meteo-froid,meteo-pluie,meteo-soleil,mini-golf,mm-apero,mm-chaud,mm-dessert,mm-entree,mm-express,mm-four,mm-froid,mm-mijote,mm-peu-importe,mm-plat,mm-sansfour,molkky,mood,muscle,musculation,musee,musique,noix,noter,objectifs,oeufs,oignon,oldmoney,paprika,parapente,parent,pas,pate-cacahuete,pate-tarte,patinoire,penderie,persil,petanque,peu-importe,photo-tenue,pique-nique,plage,poids,poisson,poivre,pommes-de-terre,pompes,poulet,pratique,proteines,publier,rafting,rando-groupe,randonnee,ranger,raquettes-neige,raquettes-plage,recette-inventee,reconfort,record,repas-potes,restaurant,rhum,rhum-blanc,rhum-overproof,rire,riz,rosalie,roti,roue,rye,salade-verte,sale,sans-alcool,sauce-chocolat,sb-cafe,sb-chaud,sb-equilibre,sb-fruit,sb-glace,sb-gourmand,sb-lait,sb-leger,sb-mixe,sb-the,scanner,sel,semaine,sirop-canne,sirop-saison,sirop-sucre,sirop-vanille,sirop-violette,ski,ski-fond,snowboard,soda-pamplemousse,soiree,sommeil,sourire,sous-vetement,souvenirs,spa,speculoos,sport,sport-co,sport-tenue,sucre,sucre-cat,surprise,sushis,tache,telephone,tendresse,tennis,tenue,tequila,the,thon,tomates,tous,trail,triple-sec,trois-idees,ufc,vanille,veau,velo,velo-route,vermouth-rouge,vermouth-sec,veste,via-ferrata,viande,video,villa,vin-blanc,vin-cuit,vin-rouge,vinaigre-balsamique,vinaigre-cidre,visite,vodka,vtt,vtt-descente,whisky,wraps'.split(',');
