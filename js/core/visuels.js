...
(function (global) {
  ...
  const DISPO = 'a-commander,a-faire,a-voir,accessoires,activite,actualiser,ail,ajouter,alcool,alcoolise,ami,angostura,anis,apero,apple-sante,apres-ski,asperges,avion,baguette-magique,bar,bas,basilic,bateau,beach-volley,betteraves,beurre,biere,blanc-oeuf,blender,boeuf,bons-plans,boomerang,boudoirs,bouillon,bouquet-garni,bourbon,boussole,bowling,brandy-mure,brunch,cacahuetes,cacao,cadeau,cafe,cafe-filtre,cafe-lieu,cafe-soluble,calendrier,calories,campari,canyoning,caramel,cardio,carottes,cassonade,cat-autre,cat-culture,cat-ete,cat-food,cat-fun,cat-hiver,cat-insolite,cat-plage,cat-sport,cerf-volant,chai,chambord,champignons,chapelure,char-voile,chaussettes,chaussures,chercher,chili,chill,chocolat-lait,chocolat-noir,cinema,citron-jaune,citron-vert,ck-bar-oui,ck-chic,ck-corse,ck-cremeux,ck-frais,ck-gin,ck-peu-importe,ck-rhum,ck-tequila,ck-tropical,ck-vodka,ck-whisky,classe,codebarre,cognac,coins-discrets,collegue,connue,coucher-soleil,couple,courgettes,cran,creme,creme-coco,creme-fraiche,crepe,croutons,culture,de,defi,dunes,eau,eau-gazeuse,effacer,elan,enfant,epices,equitation,escalade,escape,espresso,estragon,exporter,exposition,famille,farine,favoris,fierte,fondue,fratrie,fromage,fruit-passion,fruits,galerie,gaufre,gin,glace,glucides,golf,grains-cafe,grands-parents,grenadine,guide,haut,herbes,histoire,historique,huile,hydratation,ic-cafe,ic-manger,ic-savoir,ic-shopping,ic-sortir,ic-verre,jambon,jeux-plage,jus-ananas,jus-canneberge,jus-orange,jus-pamplemousse,karting,kitesurf,lait,lait-vegetal,lardons,legumes,levure,lieu,liqueur-banane,liqueur-cafe,listes,luge,luge-rail,mais,marche-defi,mascarpone,matcha,menthe,meteo-chaud,meteo-froid,meteo-pluie,meteo-soleil,mini-golf,mm-apero,mm-chaud,mm-dessert,mm-entree,mm-express,mm-four,mm-froid,mm-mijote,mm-peu-importe,mm-plat,mm-sansfour,molkky,mood,muscle,musee,noix,noter,objectifs,oeufs,oignon,oldmoney,paprika,parapente,parent,pas,pate-cacahuete,pate-tarte,patinoire,penderie,persil,petanque,peu-importe,photo-tenue,pique-nique,plage,poids,poisson,poivre,pommes-de-terre,poulet,pratique,proteines,rafting,randonnee,raquettes-neige,raquettes-plage,recette-inventee,reconfort,restaurant,rhum,rhum-blanc,rhum-overproof,rire,riz,rosalie,roti,roue,rye,salade-verte,sale,sans-alcool,sauce-chocolat,sb-cafe,sb-chaud,sb-equilibre,sb-fruit,sb-glace,sb-gourmand,sb-lait,sb-leger,sb-mixe,sb-the,scanner,sel,semaine,sirop-canne,sirop-saison,sirop-sucre,sirop-vanille,sirop-violette,ski,ski-fond,snowboard,soda-pamplemousse,soiree,sommeil,sourire,sous-vetement,spa,speculoos,sport,sport-tenue,sucre,sucre-cat,surprise,tendresse,tennis,tenue,tequila,the,thon,tomates,tous,trail,triple-sec,trois-idees,vanille,veau,velo,vermouth-rouge,vermouth-sec,veste,via-ferrata,viande,villa,vin-blanc,vin-cuit,vin-rouge,vinaigre-balsamique,vinaigre-cidre,visite,vodka,vtt,vtt-descente,whisky,wraps'.split(',');
