...
(function (global) {
  ...
  const DISPO = 'a-commander,a-faire,a-voir,activite,actualiser,ail,ajouter,alcool,alcoolise,ami,angostura,anis,asperges,baguette-magique,basilic,betteraves,beurre,biere,blanc-oeuf,blender,boeuf,bons-plans,boudoirs,bouillon,bouquet-garni,bourbon,boussole,brandy-mure,cacahuetes,cacao,cadeau,cafe,cafe-filtre,cafe-soluble,calories,campari,caramel,cardio,carottes,cassonade,cat-autre,cat-culture,cat-ete,cat-food,cat-fun,cat-hiver,cat-insolite,cat-plage,cat-sport,chai,chambord,champignons,chapelure,chercher,chili,chocolat-lait,chocolat-noir,citron-jaune,citron-vert,cognac,coins-discrets,collegue,connue,couple,courgettes,cran,creme,creme-coco,creme-fraiche,croutons,culture,de,defi,eau,eau-gazeuse,elan,enfant,epices,espresso,estragon,famille,farine,favoris,fierte,fratrie,fromage,fruit-passion,fruits,gin,glucides,grains-cafe,grands-parents,grenadine,herbes,histoire,historique,huile,hydratation,jambon,jus-ananas,jus-canneberge,jus-orange,jus-pamplemousse,lait,lait-vegetal,lardons,legumes,levure,lieu,liqueur-banane,liqueur-cafe,listes,mais,marche-defi,mascarpone,matcha,menthe,muscle,noix,noter,oeufs,oignon,paprika,parent,pas,pate-cacahuete,pate-tarte,persil,poids,poisson,poivre,pommes-de-terre,poulet,pratique,proteines,reconfort,rhum,rhum-blanc,rhum-overproof,rire,riz,roti,roue,rye,salade-verte,sale,sans-alcool,sauce-chocolat,sel,sirop-canne,sirop-saison,sirop-sucre,sirop-vanille,sirop-violette,soda-pamplemousse,sommeil,speculoos,sucre,sucre-cat,surprise,tendresse,tequila,the,thon,tomates,tous,triple-sec,trois-idees,vanille,veau,vermouth-rouge,vermouth-sec,viande,vin-blanc,vin-cuit,vin-rouge,vinaigre-balsamique,vinaigre-cidre,vodka,whisky,wraps'.split(',');
