...
(function (global) {
  ...
  const DISPO = 'a-commander,a-faire,a-voir,accessoires,activite,actualiser,ail,ajouter,alcool,alcoolise,ami,angostura,anis,apple-sante,asperges,baguette-magique,bas,basilic,beach-volley,betteraves,beurre,biere,blanc-oeuf,blender,boeuf,bons-plans,boomerang,boudoirs,bouillon,bouquet-garni,bourbon,boussole,brandy-mure,cacahuetes,cacao,cadeau,cafe,cafe-filtre,cafe-soluble,calendrier,calories,campari,caramel,cardio,carottes,cassonade,cat-autre,cat-culture,cat-ete,cat-food,cat-fun,cat-hiver,cat-insolite,cat-plage,cat-sport,cerf-volant,chai,chambord,champignons,chapelure,char-voile,chaussettes,chaussures,chercher,chili,chill,chocolat-lait,chocolat-noir,citron-jaune,citron-vert,ck-bar-oui,ck-chic,ck-corse,ck-cremeux,ck-frais,ck-gin,ck-peu-importe,ck-rhum,ck-tequila,ck-tropical,ck-vodka,ck-whisky,classe,codebarre,cognac,coins-discrets,collegue,connue,coucher-soleil,couple,courgettes,cran,creme,creme-coco,creme-fraiche,croutons,culture,de,defi,dunes,eau,eau-gazeuse,effacer,elan,enfant,epices,equitation,espresso,estragon,exporter,famille,farine,favoris,fierte,fratrie,fromage,fruit-passion,fruits,gin,glucides,golf,grains-cafe,grands-parents,grenadine,guide,haut,herbes,histoire,historique,huile,hydratation,ic-cafe,ic-manger,ic-savoir,ic-shopping,ic-sortir,ic-verre,jambon,jeux-plage,jus-ananas,jus-canneberge,jus-orange,jus-pamplemousse,lait,lait-vegetal,lardons,legumes,levure,lieu,liqueur-banane,liqueur-cafe,listes,mais,marche-defi,mascarpone,matcha,menthe,meteo-chaud,meteo-froid,meteo-pluie,meteo-soleil,mm-apero,mm-chaud,mm-dessert,mm-entree,mm-express,mm-four,mm-froid,mm-mijote,mm-peu-importe,mm-plat,mm-sansfour,mood,muscle,noix,noter,objectifs,oeufs,oignon,oldmoney,paprika,parent,pas,pate-cacahuete,pate-tarte,penderie,persil,peu-importe,photo-tenue,pique-nique,plage,poids,poisson,poivre,pommes-de-terre,poulet,pratique,proteines,randonnee,raquettes-plage,recette-inventee,reconfort,rhum,rhum-blanc,rhum-overproof,rire,riz,rosalie,roti,roue,rye,salade-verte,sale,sans-alcool,sauce-chocolat,sb-cafe,sb-chaud,sb-equilibre,sb-fruit,sb-glace,sb-gourmand,sb-lait,sb-leger,sb-mixe,sb-the,scanner,sel,semaine,sirop-canne,sirop-saison,sirop-sucre,sirop-vanille,sirop-violette,soda-pamplemousse,soiree,sommeil,sourire,sous-vetement,speculoos,sport,sport-tenue,sucre,sucre-cat,surprise,tendresse,tennis,tenue,tequila,the,thon,tomates,tous,triple-sec,trois-idees,vanille,veau,velo,vermouth-rouge,vermouth-sec,veste,viande,vin-blanc,vin-cuit,vin-rouge,vinaigre-balsamique,vinaigre-cidre,vodka,whisky,wraps'.split(',');
